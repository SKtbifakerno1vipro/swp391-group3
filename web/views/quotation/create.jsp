                ...
                <div class="dashboard-shell">
                    ...
                    <main class="main legacy-page">
                        ...
                        <c:if test="${not empty error}">
                            <div
                                style="background-color: #f8d7da; color: #721c24; padding: 12px 16px; margin-bottom: 20px; border: 1px solid #f5c6cb; border-radius: 6px; font-weight: bold; display: flex; align-items: center; gap: 8px;">
                                ...
                                <%-- Dropdown chon khach hang. Du lieu customers duoc gui tu doGet(). --%>
                                    ...
                                    <%-- Khu vuc search san pham va add vao quotation. --%>
                                        ...
                                        <div
                                            ...
                                            <input type="text" id="productSearch" placeholder="Tìm kiếm tên sản phẩm..."
                                                autocomplete="off" onkeyup="showCreateProductSuggestions()"
