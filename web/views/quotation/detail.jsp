                    ...
                    <main class="main legacy-page">
                        ...
                        <%-- Hien thi thong bao sau khi thao tac. --%>
                            <c:if test="${message == 'saveSuccess'}">
                                <p style="color: green; font-weight: bold;">Lưu thành công.</p>
                            </c:if>
                            <c:if test="${message == 'saveFailed'}">
                                <p style="color: red; font-weight: bold;">Lưu thất bại. Vui lòng thử lại.</p>
                            </c:if>
                            <c:if test="${message == 'addSuccess'}">
                                <p style="color: green; font-weight: bold;">Thêm sản phẩm thành công.</p>
                            </c:if>
                            <c:if test="${message == 'addFailed'}">
                                <p style="color: red; font-weight: bold;">Thêm sản phẩm thất bại.</p>
                            </c:if>
                            <c:if test="${message == 'deleteSuccess'}">
                                <p style="color: green; font-weight: bold;">Xóa sản phẩm thành công.</p>
                            </c:if>
                            <c:if test="${message == 'deleteFailed'}">
                                <p style="color: red; font-weight: bold;">Xóa sản phẩm thất bại.</p>
                            </c:if>
                            <c:if test="${message == 'invalidInput'}">
                                <p style="color: red; font-weight: bold;">Dữ liệu đầu vào không hợp lệ.</p>
                            </c:if>
                            <c:if test="${message == 'accepted'}">
                                <p style="color: green; font-weight: bold;">Đã duyệt báo giá thành công.</p>
                            </c:if>
                            <c:if test="${message == 'rejected'}">
                                <p style="color: green; font-weight: bold;">Đã hủy/từ chối báo giá thành công.</p>
                            </c:if>
                            <c:if test="${message == 'permissionDenied'}">
                                <p style="color: red; font-weight: bold;">Bạn không có quyền thực hiện thao tác này.</p>
                            </c:if>
                            <c:if test="${message == 'invalidStatus'}">
                                <p style="color: red; font-weight: bold;">Không thể sửa đổi báo giá đã duyệt hoặc đã từ
                                    chối.</p>
                            </c:if>
                            ...
                            <%-- Khoi nay hien thi thong tin chung cua quotation. --%>
                                ...
                                <table border="1" cellpadding="7" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <c:choose>
                                                ...
                                                <c:when test="${quotation.quotationStatus == 'PENDING'}">Chờ duyệt
                                                </c:when>
                                                <c:when test="${quotation.quotationStatus == 'ACCEPTED'}">Đã duyệt
                                                </c:when>
                                                <c:when test="${quotation.quotationStatus == 'REJECTED'}">Đã từ chối
                                                </c:when>
                                    ...
                                    <tr>
                                        ...
                                        <td><strong>
                                                <fmt:formatNumber
                                                    value="${quotation.totalPrice != null ? quotation.totalPrice : 0}"
                                ...
                                <%-- Form them san pham moi vao quotation hien tai bang searchbar. --%>
                                    <c:if
                                        test="${(sessionScope.user.roleId == 1 || sessionScope.user.roleId == 4) && isAllowedToManage && (quotation.quotationStatus == 'DRAFT' || quotation.quotationStatus == 'PENDING')}">
                                        <h2>Thêm sản phẩm</h2>
                                        <form action="${pageContext.request.contextPath}/quotation-detail"
                                            method="post">
                                            <input type="hidden" name="quotationId" value="${quotation.quotationId}">
                                            <input type="hidden" name="productId" id="addProductId">

                                            <label>Tìm kiếm sản phẩm:</label>
                                            <input type="text" id="addProductSearch" placeholder="Nhập tên sản phẩm..."
                                                autocomplete="off" onkeyup="showProductSuggestions()">

                                            <%-- Hop goi y san pham sau khi search. --%>
                                                <div id="productSuggestions"
                                                    style="border: 1px solid #ccc; max-width: 420px; display: none; background: white; position: absolute; z-index: 10;">
                                                </div>

                                                <span id="selectedProductName"
                                                    style="font-weight: bold; color: green; margin-left: 10px;"></span>
                                                ...
                                                <div
                                                    ...
                                                    <div>
                                                        <label>Đơn vị:</label>
                                                        <input type="text" id="addUnit" readonly
                                                            style="width: 75px; background-color: #f1f1f1; border: 1px solid #ccc; padding: 4px;">
                                                    </div>
                                                    <div>
                                                        <label>Giá bán:</label>
                                                        <input type="number" id="addSellingPrice" readonly
                                                            style="width: 110px; background-color: #f1f1f1; border: 1px solid #ccc; padding: 4px;">
                                                    </div>
                                                    <div>
                                                ...
                                                <button type="submit" name="action" value="addProduct"
                                                    onclick="return validateAddProductForm()">Thêm sản phẩm</button>
                                        </form>
                                        <br>
                                    </c:if>
                                    ...
                                    <%-- Khoi nay hien thi va cho sua danh sach san pham trong quotation. --%>
                                        <c:if
                                            ...
                                            <div style="margin-bottom: 15px;">
                                                <form action="${pageContext.request.contextPath}/quotation-detail"
                                                    ...
                                                    <input type="number" name="taxPercent" min="0" max="100" step="0.01"
                                                        value="0" required>

                                                    <button type="submit" style="margin-left: 10px;">Áp dụng cho tất cả
                                                        sản phẩm</button>
                                                </form>
                                            </div>
                                        </c:if>
                                        ...
                                        <table border="1" cellpadding="7" cellspacing="0" style="width: 100%;">
                                            ...
                                            <tbody>
                                                <c:if test="${empty details}">
                                                    <tr>
                                                        <td colspan="10" style="text-align: center;">Không tìm thấy chi
                                                            tiết sản phẩm nào.</td>
                                                    </tr>
                                                </c:if>
                                                ...
                                                <c:forEach items="${details}" var="detail">
                                                    <tr>
                                                        <form
                                                            action="${pageContext.request.contextPath}/quotation-detail"
                                                            method="post">
                                                            <td>
                                                                ${detail.productName}
                                                            ...
                                                            <c:if test="${sessionScope.user.roleId != 3}">
                                                                <td>
                                                                    <fmt:formatNumber value="${detail.costPrice}"
                                                                        type="number" minFractionDigits="2"
                                                                        maxFractionDigits="2" />
                                                                </td>
                                                            </c:if>
                                                            <td>
                                                                <fmt:formatNumber value="${detail.sellingPrice}"
                                                                    type="number" minFractionDigits="2"
                                                                    maxFractionDigits="2" />
                                                                ...
                                                                <c:choose>
                                                                    <c:when
                                                                        ...
                                                                        <input type="number" name="discountPercent"
                                                                            ...
                                                                            value="${detail.discountPercent}" readonly
                                                                            style="width: 70px;">
                                                                    </c:when>
                                                                    <c:otherwise>
                                                            ...
                                                            <td>
                                                                <c:choose>
                                                                    <c:when
                                                                        test="${(sessionScope.user.roleId == 1 || sessionScope.user.roleId == 4) && isAllowedToManage && (quotation.quotationStatus == 'DRAFT' || quotation.quotationStatus == 'PENDING')}">
                                                                        <input type="number" name="taxPercent" min="0"
                                                                            max="100" step="0.01"
                                                                            value="${detail.taxPercent}" readonly
                                                                            style="width: 70px;">
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        ${detail.taxPercent}
                                                            ...
                                                            <c:if
                                                                ...
                                                                <td>
                                                                    <input type="hidden" name="quotationId"
                                                                        value="${quotation.quotationId}">
                                                                    <input type="hidden" name="quotationDetailId"
                                                                        value="${detail.quotationDetailId}">
                                                                    <button type="submit" name="action"
                                                                        value="updateDetail">Lưu</button>
                                                                    <button type="submit" name="action"
                                                                        value="deleteProduct"
                                                                        onclick="return confirm('Bạn có chắc chắn muốn xóa sản phẩm này khỏi báo giá?')">Xóa</button>
                                                                </td>
                                                            </c:if>
                                                        </form>
                                                    </tr>
                                                ...
                                                <tr style="background-color: #f9f9f9;">
                                                    <td colspan="${sessionScope.user.roleId != 3 ? 7 : 6}"
                                                        style="text-align: right; font-weight: bold;">Tổng cộng:</td>
                                        ...
                                        <%-- Khoi nay hien thi lich su negotiation cua quotation. --%>
                                            ...
                                            <table border="1" cellpadding="7" cellspacing="0" style="width: 100%;">
                                                ...
                                                <tbody>
                                                    <c:if test="${empty histories}">
                                                        <tr>
                                                            <td colspan="3" style="text-align: center;">Không tìm thấy
                                                                lịch sử nào.</td>
                                                        </tr>
                                                    </c:if>
                                                    ...
                                                    <c:forEach items="${histories}" var="history">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <c:out
                                                                    value="${history.createdByName != null ? history.createdByName : 'Hệ thống'}" />
                                                            </td>
                                            ...
                                            <div style="margin-top: 20px;">
                                                <c:if
                                                    test="${(sessionScope.user.roleId == 1 || sessionScope.user.roleId == 4) && isAllowedToManage && (quotation.quotationStatus == 'DRAFT' || quotation.quotationStatus == 'PENDING')}">
                                                    <form action="quotation-detail" method="POST"
                                                        style="display:inline;">
                                                        <input type="hidden" name="quotationId"
                                                            value="${quotation.quotationId}">
                                                        <input type="hidden" name="action" value="accept">
                                                        <button type="submit"
                                                            style="padding: 10px 20px; background-color: #4CAF50; color: white; border: none; cursor: pointer;">Duyệt
                                                            báo giá</button>
                                                    </form>
                                                    ...
                                                    <form action="quotation-detail" method="POST"
                                                        ...
                                                        <button type="submit"
                                                            ...
                                                            onclick="return confirm('Bạn có chắc chắn muốn hủy/từ chối báo giá này không?')">Hủy
                                                            báo giá</button>
                                                    </form>
                                                </c:if>
                                            </div>
                                            ...
                                            <br>
                                            <a href="${pageContext.request.contextPath}/quotation-list">Quay lại danh
                                                sách</a>
