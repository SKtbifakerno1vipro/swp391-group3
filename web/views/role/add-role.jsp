                            ...
                            <c:otherwise>
                                <div class="permission-grid">
                                    <c:forEach var="permission" items="${permissionList}">
                                        <label class="permission-card"><input class="terra-checkbox" type="checkbox" name="permissionIds" value="${permission.permissionId}"><span><c:out value="${permission.permissionName}"/></span></label>
                                    </c:forEach>
                                </div>
                            </c:otherwise>
                        </c:choose>
