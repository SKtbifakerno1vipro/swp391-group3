                ...
                <nav class="nav-group" aria-label="Main navigation">
                    <c:choose>
                        ...
                        <c:when test="${sessionScope.user.roleId == 1}">
                            ...
                            <a class="nav-link ${param.activeMenu == 'users' ? 'active' : ''}" href="${pageContext.request.contextPath}/user-list" title="Quản lý Người dùng"><div class="sidebar-icon-wrap"><span class="material-symbols-outlined">manage_accounts</span></div><span class="sidebar-text">Quản lý Người dùng</span></a>
                            <a class="nav-link ${param.activeMenu == 'roles' ? 'active' : ''}" href="${pageContext.request.contextPath}/role-list" title="Quản lý Vai trò"><div class="sidebar-icon-wrap"><span class="material-symbols-outlined">admin_panel_settings</span></div><span class="sidebar-text">Quản lý Vai trò</span></a>
                            <a class="nav-link ${param.activeMenu == 'customers' ? 'active' : ''}" href="${pageContext.request.contextPath}/customer/list" title="Quản lý Khách hàng"><div class="sidebar-icon-wrap"><span class="material-symbols-outlined">groups</span></div><span class="sidebar-text">Quản lý Khách hàng</span></a>
                            <a class="nav-link ${param.activeMenu == 'quotations' ? 'active' : ''}" href="${pageContext.request.contextPath}/quotation-list" title="Quản lý Báo giá"><div class="sidebar-icon-wrap"><span class="material-symbols-outlined">request_quote</span></div><span class="sidebar-text">Quản lý Báo giá</span></a>
                            ...
                            <a class="nav-link ${param.activeMenu == 'payments' ? 'active' : ''}" href="${pageContext.request.contextPath}/payment/list" title="Quản lý Thanh toán"><div class="sidebar-icon-wrap"><span class="material-symbols-outlined">payments</span></div><span class="sidebar-text">Quản lý Thanh toán</span></a>
                            <a class="nav-link ${param.activeMenu == 'invoices' ? 'active' : ''}" href="${pageContext.request.contextPath}/invoice-list" title="Quản lý Hóa đơn"><div class="sidebar-icon-wrap"><span class="material-symbols-outlined">receipt</span></div><span class="sidebar-text">Quản lý Hóa đơn</span></a>
                        ...
                        <c:when test="${sessionScope.user.roleId == 3}">
                            <a class="nav-link ${param.activeMenu == 'dashboard' ? 'active' : ''}" href="${pageContext.request.contextPath}/dashboard" title="Bảng điều khiển"><div class="sidebar-icon-wrap"><span class="material-symbols-outlined">dashboard</span></div><span class="sidebar-text">Bảng điều khiển</span></a>
                            <a class="nav-link ${param.activeMenu == 'categories' ? 'active' : ''}" href="${pageContext.request.contextPath}/category/list" title="Danh mục sản phẩm"><div class="sidebar-icon-wrap"><span class="material-symbols-outlined">category</span></div><span class="sidebar-text">Danh mục</span></a>
                            ...
                            <a class="nav-link ${param.activeMenu == 'quotations' ? 'active' : ''}" href="${pageContext.request.contextPath}/quotation-list" title="Báo giá của tôi"><div class="sidebar-icon-wrap"><span class="material-symbols-outlined">request_quote</span></div><span class="sidebar-text">Báo giá</span></a>
                            <a class="nav-link ${param.activeMenu == 'contracts' ? 'active' : ''}" href="${pageContext.request.contextPath}/contract-list" title="Hợp đồng của tôi"><div class="sidebar-icon-wrap"><span class="material-symbols-outlined">contract</span></div><span class="sidebar-text">Hợp đồng</span></a>
                            <a class="nav-link ${param.activeMenu == 'orders' ? 'active' : ''}" href="${pageContext.request.contextPath}/customer-order-list" title="Đơn hàng của tôi"><div class="sidebar-icon-wrap"><span class="material-symbols-outlined">receipt_long</span></div><span class="sidebar-text">Đơn hàng</span></a>
                            ...
                            <a class="nav-link ${param.activeMenu == 'invoices' ? 'active' : ''}" href="${pageContext.request.contextPath}/invoice-list" title="Hóa đơn của tôi"><div class="sidebar-icon-wrap"><span class="material-symbols-outlined">receipt</span></div><span class="sidebar-text">Hóa đơn</span></a>
