        ...
        <div class="dashboard-shell">
            ...
            <main class="main">
                <section class="topbar">
                    <div><p class="eyebrow">Enterprise Dashboard</p><h1>Welcome back, <c:out value="${user.fullName}"/>.</h1><p>Overview of customers, products, quotations, contracts and customer orders in your sales workflow.</p></div><div class="top-actions"><a class="button" href="${pageContext.request.contextPath}/create-product"><span class="material-symbols-outlined">add_box</span>New product</a><a class="button primary" href="${pageContext.request.contextPath}/quotation-create"><span class="material-symbols-outlined">post_add</span>Create quotation</a></div></section>
                <section class="hero"><div class="panel hero-card"><p class="eyebrow">Sales workflow</p><h2>Manage B2B bread sales from quotation to delivery.</h2><div class="quick-grid"><a class="quick-link" href="${pageContext.request.contextPath}/customer/list">Customer CRM<span>Profiles, tax code, contacts</span></a><a class="quick-link" href="${pageContext.request.contextPath}/quotation-list">Quotation center<span>Pricing proposals and approval</span></a><a class="quick-link" href="${pageContext.request.contextPath}/customer-order-list">Order tracking<span>Status and fulfillment history</span></a></div></div><div class="panel status-panel"><div class="panel-title"><h2>Order Status</h2><span class="badge"><c:out value="${totalOrders}"/> total</span></div><div class="status-list"><c:forEach var="entry" items="${orderStatusCounts}"><div class="status-item"><span><c:out value="${entry.key}"/></span><strong><c:out value="${entry.value}"/></strong></div></c:forEach><c:if test="${empty orderStatusCounts}"><div class="empty-state">No order data yet.</div></c:if></div></div></section>
