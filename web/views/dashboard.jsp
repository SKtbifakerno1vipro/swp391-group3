        ...
        <style>
            ...
            * {
            ...
            .brand {
                ...
                gap:12px;
                padding:0 8px;
                animation:sidebarFadeIn .5s ease-out;
            }
            .brand-mark {
                width:44px;
                height:44px;
            ...
            .nav-link:hover .material-symbols-outlined,.nav-link.active .material-symbols-outlined {
            ...
            .sidebar-footer {
                ...
                animation:sidebarFadeIn .65s ease-out;
            }
            .user-card {
                display:flex;
                gap:12px;
