    ...
    <head>
        ...
        <style>
            ...
            * { box-sizing: border-box; }
            ...
            .subtitle { margin: 10px 0 30px; color: var(--muted); line-height: 1.6; }
            ...
            .input-wrap span { color: var(--primary); }
            ...
            @media (max-width: 900px) {
                ...
                .brand-panel { min-height: 430px; padding: 34px 24px; }
                .logo-frame { width: min(300px, 78%); }
            ...
            <section class="login-card">
                <aside class="brand-panel">
                    ...
                    <div class="brand-copy">
                        <div class="logo-frame">
                            <img src="${pageContext.request.contextPath}/assets/img/po-bread-logo.jpg" alt="Po Bread logo">
                        </div>
                        <h1>Po Bread</h1>
                        <p>Sales Process Digitalization System for managing customers, products, quotations, contracts and orders.</p>
                        <div class="brand-badges">
                            <span class="brand-badge"><span class="material-symbols-outlined">verified</span>Trusted Portal</span>
                            <span class="brand-badge"><span class="material-symbols-outlined">bakery_dining</span>Po Bread Team</span>
                        </div>
                    </div>
                    <div></div>
                </aside>
                ...
                <section class="form-panel">
                    <div class="form-inner">
                        ...
                        <h2>Welcome back</h2>
                        <p class="subtitle">Sign in with your account to continue managing the Po Bread sales workflow.</p>
                        ...
                        <form action="${pageContext.request.contextPath}/login" method="post">
                            ...
                            <div class="form-row">
                                ...
                                <a href="${pageContext.request.contextPath}/user/password/forgot">Forgot password?</a>
                            </div>
