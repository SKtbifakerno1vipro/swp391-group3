<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link
            href="https://fonts.googleapis.com/css2?family=Literata:wght@400;600;700&family=Nunito+Sans:wght@300;400;600;700;800&display=swap"
            rel="stylesheet">
        <link
    ...
    <body class="min-h-screen bg-background font-body text-on-surface flex items-center justify-center p-6">
        ...
        <main
            class="flex w-full max-w-5xl bg-surface rounded-2xl shadow-xl overflow-hidden min-h-[600px] border border-outline/30">

            <!-- Left section -->
            <section
                class="hidden lg:flex lg:w-1/2 hero-gradient p-12 flex-col justify-center text-white items-center text-center">
                ...
                <div class="w-full max-w-md mx-auto space-y-8">
                    ...
                    <form action="${pageContext.request.contextPath}/login" method="post" class="space-y-6">
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-outline"><span
                        ...
                        <div class="flex items-center justify-between text-sm">
                            <label class="flex items-center gap-2 cursor-pointer group">
                                ...
                                <span
                                    class="text-on-surface-variant group-hover:text-primary transition-colors">Remember
                                    me</span>
                            </label>
                        ...
                        <button type="submit"
                            class="w-full py-4 bg-primary text-white rounded-xl font-bold tracking-wide shadow-md hover:bg-on-primary-fixed-variant hover:shadow-lg active:scale-[0.98] transition-all">
                            Login
                        </button>

                        <c:if test="${not empty error}">
                            <p class="text-center text-sm font-medium text-error p-3 bg-error/10 rounded-lg">${error}
                            </p>
                        </c:if>
                    </form>
