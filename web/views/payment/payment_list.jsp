                    ...
                    <c:if test="${empty list}">
                        ...
                        <c:forEach items="${list}" var="p">
                            <tr>
                                ...
                                <td>
                                    <a href="${pageContext.request.contextPath}/payment/detail?id=${p.paymentId}" style="color: #0284c7; text-decoration: none; font-weight: bold; margin-right: 10px; display: inline-block; vertical-align: middle;">Chi tiết</a>
                                    <c:if test="${not empty p.invoice}"> 
                                        <c:choose>
                                            <c:when test="${p.paymentStatus == 'COMPLETED' && p.invoice.invoiceStatus == 'READY' && sessionScope.user.roleId != 3}">
