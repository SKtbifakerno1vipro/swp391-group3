...
<head>
    ...
    <title>Create User - SaleFlow</title>
...
<body class="flex min-h-screen bg-background">
    ...
    <div class="flex-1 md:ml-[240px] flex flex-col">
        ...
        <main class="p-container-margin">
            <div class="max-w-3xl mx-auto bg-surface-main rounded-xl border border-border-subtle shadow-sm overflow-hidden">
                <div class="p-stack-lg border-b border-border-subtle bg-surface-alt">
                    <h3 class="font-headline-md text-on-surface">User Information</h3>
                    <p class="font-body-md text-on-surface-variant">Fill in the details to create a new enterprise account.</p>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" id="userName" name="userName" value="${u.userName}" required minlength="4" maxlength="20"
                                   ...
                                   title="Username từ 4-20 ký tự, chỉ chứa chữ, số và gạch dưới."
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="email" id="email" name="email" value="${u.email}" required minlength="4" maxlength="50"
                                   class="w-full px-4 py-2 rounded-lg border border-border-subtle focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all font-body-md" />
                        </div>
                        ...
                        <div class="space-y-2">
                            <label class="font-label-md text-on-surface-variant" for="roleId">Assign Role</label>
