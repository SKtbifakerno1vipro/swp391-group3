...
<head>
    <meta charset="UTF-8">
    <title>Cập nhật mật khẩu - Terra Enterprise</title>
    <style>
        .form-container {
            max-width: 480px;
            margin: 40px auto;
...
<body>
    <div class="dashboard-shell">
        ...
        <main class="main legacy-page">
            <div class="form-container" style="background: var(--surface); border: 1px solid rgba(221, 213, 201, 0.85); border-radius: 22px; box-shadow: var(--shadow); padding: 30px; width: 100%; max-width: 480px;">
                ...
                <form action="${pageContext.request.contextPath}/user/password/change" method="POST">
                    ...
                    <button type="submit" name="action" value="changePassword" class="btn-submit">Cập nhật mật khẩu</button>
                </form>
            </div>
        </main>
    </div>
