...
<body class="flex min-h-screen bg-background">
    ...
    <aside class="hidden md:flex flex-col h-full py-stack-lg bg-surface-alt border-r border-border-subtle fixed left-0 top-0 w-[240px] z-50">
        ...
        <nav class="flex-1 px-4 space-y-2">
            <a class="flex items-center gap-3 px-4 py-3 rounded-lg bg-surface-container text-primary font-semibold border-r-4 border-primary transition-all scale-95 font-body-md text-body-md" href="#">
