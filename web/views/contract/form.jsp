                ...
                <c:if test="${editable}">
                    ...
                    <c:if test="${contract != null}">
                        ...
                        <c:if test="${sessionScope.user.roleId == 2}">
                            <button type="button" class="btn btn-approve" onclick="submitForm('manager_approve')">Lưu &
                                Duyệt (Approve)</button>
                        </c:if>

                        <c:if test="${sessionScope.user.roleId == 5}">
                            <button type="button" class="btn btn-review" onclick="submitForm('submit_for_review')">Gửi
                                duyệt lại</button>
                        </c:if>
                    </c:if>
                </c:if>
