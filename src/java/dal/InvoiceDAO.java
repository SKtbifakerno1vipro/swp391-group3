...
public class InvoiceDAO extends DBContext {
    ...
    public String getNextInvoiceNo(int year) {
        String sql = "SELECT MAX(invoice_no) as max_no FROM invoice WHERE YEAR(issue_date) = ?";
    ...
    public int insertInvoice(Invoice invoice) {
        ...
        // Auto-generate invoice_no if empty/invalid/default
        if (invoice.getInvoiceNo() == null || invoice.getInvoiceNo().trim().isEmpty() 
                || invoice.getInvoiceNo().equals("0") || invoice.getInvoiceNo().startsWith("INV-") 
        ...
        String sql = "INSERT INTO invoice (customer_contract_id, customer_order_id, invoice_no, issue_date, invoice_status, "
                + "invoice_type, invoice_symbol, seller_name, seller_tax_code, seller_address, "
        ...
        try (PreparedStatement ps = connection.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS)) {
            ...
            ps.setString(11, invoice.getBuyerName());
            ps.setString(12, invoice.getBuyerTaxCode());
            ps.setString(13, invoice.getBuyerAddress());
            
            ps.setBigDecimal(14, invoice.getSubTotal());
            ps.setBigDecimal(15, invoice.getTaxAmount());
            ps.setBigDecimal(16, invoice.getTotalAmount());
