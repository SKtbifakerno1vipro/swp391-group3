...
public class ContractController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request,
        ...
        if ("terminate".equals(action)) {
            ...
            dao.terminate(contractId, (java.sql.Date) today);
            roomDAO.updateStatus(roomId, "A");
        ...
        // VIEW
        List<Contract> list = dao.getAll();
        request.setAttribute("contracts", list);
        request.getRequestDispatcher("/view/admin/ContractList.jsp")
