...
public class UserController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action) {
            // 8. User List: Hiá»ƒn thá»‹ danh sÃ¡ch user (cÃ³ filter)
            case "list":
            ...
            // 9. User Detail: Hiá»ƒn thá»‹ chi tiáº¿t 1 user
            case "view":
            ...
            // 11. Edit User: Hiá»ƒn thá»‹ form edit
            case "edit":
            ...
            // 10. Create User: Hiá»ƒn thá»‹ form táº¡o má»›i
            case "create":
                request.getRequestDispatcher("views/user/form.jsp").forward(request, response);
                break;
        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // Náº¿u khÃ´ng cÃ³ userId = táº¡o má»›i, náº¿u cÃ³ = cáº­p nháº­t
